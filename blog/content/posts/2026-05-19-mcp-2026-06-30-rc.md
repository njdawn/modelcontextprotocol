---
title: "The 2026-06-30 MCP Specification Release Candidate"
date: "2026-05-19T09:00:00+00:00"
publishDate: "2026-05-19T09:00:00+00:00"
slug: 2026-06-30-release-candidate
...
idea whether the result is safe to share.
...
The release candidate for MCP **2026-06-30** is now available. It is the largest
...
> **June 30, 2026**. This release contains breaking changes; see
...
In `2026-06-30`, the same call is a single self-contained request that any
...
Servers that need to carry state across calls do it the way HTTP APIs always
have: mint an explicit handle (a `basket_id`, a `browser_id`) from a tool and
have the model pass it back as an ordinary argument on later calls.
...
and validate the `iss` parameter on authorization responses per
[RFC 9207](https://www.rfc-editor.org/rfc/rfc9207) to mitigate mix-up attacks in
...
implementers targeting 2026-06-30 will be able to adopt future revisions without
rewriting their transport or lifecycle code.

## Release Timeline and Validation

The release candidate is locked as of **May 19, 2026**. The final specification
will be published on **June 30, 2026**. The six-week window is for SDK
...
timeline, and a lifecycle policy that lets implementers build on 2026-06-30
